...
var strsv = require( './../lib/ndarray.js' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof strsv, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 11', function test( t ) {
	t.strictEqual( strsv.length, 11, 'returns expected value' );
	t.end();
});
...
tape( 'the function throws an error if provided an invalid first argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( value, data.trans, data.diag, data.N, new Float32Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Float32Array( data.x ), data.strideX, data.offsetX );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid second argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( data.uplo, value, data.diag, data.N, new Float32Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Float32Array( data.x ), data.strideX, data.offsetX );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid third argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( data.uplo, data.trans, value, data.N, new Float32Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Float32Array( data.x ), data.strideX, data.offsetX );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid fourth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( data.uplo, data.trans, data.diag, value, new Float32Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Float32Array( data.x ), data.strideX, data.offsetX );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid sixth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( data.uplo, data.trans, data.diag, data.N, new Float32Array( data.A ), value, data.strideA2, data.offsetA, new Float32Array( data.x ), data.strideX, data.offsetX );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid seventh argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( data.uplo, data.trans, data.diag, data.N, new Float32Array( data.A ), data.strideA1, value, data.offsetA, new Float32Array( data.x ), data.strideX, data.offsetX );
		};
	}
});
...
tape( 'the function throws an error if provided an invalid tenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strsv( data.uplo, data.trans, data.diag, data.N, new Float32Array( data.A ), data.strideA1, data.strideA2, data.offsetA, new Float32Array( data.x ), value, data.offsetX );
		};
	}
});
...
tape( 'if `N` is zero, the function returns the input vector unchanged (row-major)', function test( t ) {
	...
	out = strsv( data.uplo, data.trans, data.diag, 0, a, data.strideA1, data.strideA2, data.offsetA, x, data.strideX, data.offsetX );
	t.strictEqual( out, x, 'returns expected value' );
